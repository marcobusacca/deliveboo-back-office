                        ...
                        <div class="form-group my-4">
                            @if (!empty($restaurant->cover_image))
                                <div class="my-4">
                                    ...
                                    <a href="{{ route('admin.restaurants.edit.delete-cover-image', $restaurant) }}" class="btn btn-danger my-3">Cancella Copertina</a>
                                </div>
                            @endif
                            <div class="my-4">
                                @if (!empty($restaurant->cover_image))
                                    <!-- New Cover Image Label -->
                                    <label class="control-label my-2">Nuova Logo del Ristorante:</label>
                                @else
                                    <!-- Cover Image Label -->
